...
class Breadcrumbs {
	...
	public function __construct() {
		$this->args = array(
			...
			'label_home'      => __( 'Home', 'estar' ),
			// Translators: search query.
			'label_search'    => __( 'Search Results for &#8220;%s&#8221;', 'estar' ),
			'label_404'       => __( 'Page not found', 'estar' ),
		);
	}
	...
	public function render( $args = [] ) {
		...
		$output = sprintf( '<nav class="breadcrumbs" aria-label="%s">', esc_attr__( 'Breadcrumbs', 'estar' ) );
